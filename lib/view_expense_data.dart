...
import 'Utils.dart';
import 'home.dart';
import 'package:project_1/data/expenseData.dart' as expenseData;
...
class ViewExpenseData extends StatefulWidget {
  @override
  _ViewExpenseDataState createState() => _ViewExpenseDataState();
}

class _ViewExpenseDataState extends State<ViewExpenseData> {
  ...
  void initState() {
    super.initState();
    this.datas = List.of(expenseData.allExpense);
  }
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    appBar: AppBar(
      title: Text("Manage/View Expense Data"),
